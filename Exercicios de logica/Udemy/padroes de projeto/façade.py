"""
Façade (Fachada) é um padrão de projeto estrutural que tem a intenção de fornecer uma interface unificada para um
conjunto de interface de nivel mais alto que torna o subsistema mais facil de ser usado.
"""
...
class Notebook(IObserver):
    ...
    def show(self):
        ...
        print(f'Sou o notebook da {self.name} e vou fazer outra coisa com esses dados => ', state)
...
class WeatherStationFacade:
    def __init__(self) -> None:
        ...
        self.notebook = Notebook('Positivo', self.weather_station)
