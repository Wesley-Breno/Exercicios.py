"""
O padrão Observer tem a intenção de definir uma dependência de um-para-muitos entre objetos, de maneira que quando um
...
if __name__ == '__main__':
    ...
    notebook = Notebook('Positivo', weather_station)
