"""
É um padrão de criação que tem a intenção de separar a construção de um objeto complexo da sua representação, de modo
...
class UserDirector:
    ...
    def with_address(self, firstname, lastname, address):
        ...
        self._builder.add_addresses(address)
        return self._builder.result
...
if __name__ == '__main__':
    ...
    user2 = user_director.with_address('Luiz', 'otavio', 'rua da moeda')
    print(user1)
    print(user2)
