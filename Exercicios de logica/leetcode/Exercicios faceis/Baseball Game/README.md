<h1>Baseball Game</h1>
<div class="xFUwe" data-track-load="description_content"><p>You are keeping the scores for a baseball game with strange rules. At the beginning of the game, you start with an empty record.</p>
