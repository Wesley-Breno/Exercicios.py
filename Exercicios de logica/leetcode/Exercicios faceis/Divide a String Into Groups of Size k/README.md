<h1>Divide a String Into Groups of Size k</h1>
<div class="elfjS" data-track-load="description_content"><p>A string <code>s</code> can be partitioned into groups of size <code>k</code> using the following procedure:</p>
