<h1>Sorting the Sentence</h1>
<div class="elfjS" data-track-load="description_content"><p>A <strong>sentence</strong> is a list of words that are separated by a single space with no leading or trailing spaces. Each word consists of lowercase and uppercase English letters.</p>
