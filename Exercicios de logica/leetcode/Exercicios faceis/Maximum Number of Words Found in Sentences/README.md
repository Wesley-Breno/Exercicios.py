<h1>Maximum Number of Words Found in Sentences</h1>
<div class="elfjS" data-track-load="description_content"><p>A <strong>sentence</strong> is a list of <strong>words</strong> that are separated by a single space&nbsp;with no leading or trailing spaces.</p>
