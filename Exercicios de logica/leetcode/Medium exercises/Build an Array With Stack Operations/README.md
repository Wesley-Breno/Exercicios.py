<h1>Build an Array With Stack Operations</h1>
<div class="elfjS" data-track-load="description_content"><p>You are given an integer array <code>target</code> and an integer <code>n</code>.</p>
