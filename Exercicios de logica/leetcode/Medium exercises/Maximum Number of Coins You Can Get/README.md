<h1>Maximum Number of Coins You Can Get</h1>
<div class="elfjS" data-track-load="description_content"><p>There are <code>3n</code> piles of coins of varying size, you and your friends will take piles of coins as follows:</p>
