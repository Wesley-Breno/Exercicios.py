<h1>Find The Original Array of Prefix Xor</h1>
<div class="elfjS" data-track-load="description_content"><p>You are given an <strong>integer</strong> array <code>pref</code> of size <code>n</code>. Find and return <em>the array </em><code>arr</code><em> of size </em><code>n</code><em> that satisfies</em>:</p>
