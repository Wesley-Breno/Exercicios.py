<h1>Seat Reservation Manager</h1>
<div class="elfjS" data-track-load="description_content"><p>Design a system that manages the reservation state of <code>n</code> seats that are numbered from <code>1</code> to <code>n</code>.</p>
