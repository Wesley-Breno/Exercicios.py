"""
Mediator é um padrão de projeto comportamental que tem a intenção de definir um objeto que encapsula a forma como um
conjunto de objetos interage. O mediator promove o baixo acoplamento ao evitar que os objetos se refiram uns aos outros
...
if __name__ == '__main__':
    ...
    joao.broadcast('Ola pessoal :)')
    maria.broadcast('OLAAAA')
    elisa.broadcast('OIoi')

    print()

    joao.send_direct('Maria', 'Iae maria, tudo bao? :)')
